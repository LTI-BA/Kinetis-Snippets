...
/* ADC_init()
 * Calibrates and initializes ADC0 to perform conversions from different channels
...
void ADC_init(void)
{
	...
	ADC0_CFG1 |=  ADC_CFG1_ADICLK(0)| ADC_CFG1_ADIV(0) | ADC_CFG1_MODE(3) | ADC_CFG1_ADLSMP(1) ;
